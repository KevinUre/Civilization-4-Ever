...
##### DeathMaker900 Start
		elif (CivilopediaPageTypes.CIVILOPEDIA_PAGE_CONCEPT_FOREVER == self.iCivilopediaPageType):
			iNum = gc.getNumForeverConceptInfos()
##### DeathMaker900 End
...
##### DeathMaker900 START
			...
			info = gc.getForeverConceptInfo(iEntry)
##### DeathMaker900 END
		elif (CivilopediaPageTypes.CIVILOPEDIA_PAGE_SPECIALIST == self.iCivilopediaPageType):
