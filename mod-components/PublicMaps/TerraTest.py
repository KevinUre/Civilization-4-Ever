...
def getCustomMapOptionName(argsList):
	...
	option_names = {
		...
		2:	"TXT_KEY_MAP_SCRIPT_MOUNTAIN_PATTERN",
		3:	"TXT_KEY_MAP_SCRIPT_MOUNTAIN_DENSITY"
		}
...
class TerraMultilayeredFractal(CvMapGeneratorUtil.MultilayeredFractal):
	...
	def generatePlotsByRegion(self):
        ...
        #DEATH
	    userInputGrain = map.getCustomMapOption(2)
	    userInputPeaks = map.getCustomMapOption(3)
        worldsizes = {
